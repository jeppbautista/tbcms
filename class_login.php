...
?>
           <div class="nav-container">
                <div class="col-md-5" style="padding-bottom: 5px;">
                  ...
                  <img width="100px" src="https://tbcmerchantservices.com/images/tbslogo.png"> </a>
                </div>
    ...
    public function show_main_parallax(){
      ?>
      <style>
     .parallax {
       /* The image used */
       background-image: url("https://tbcmerchantservices.com/images/cover-phot.jpg");
